...
; ==============================================================================================
; ⚠️ far, 645 lignes, NON DÉTAILLÉE — grosse machine à états dispatchant sur byte_722D1
; (valeurs 0Fh/19h/20h/...), pilote un écran/dialogue (widgets autour de l'id 5A92h), pose des
; minuteurs (Timer_SetRelativeFrames). Référencée via vtable (DATA XREF seg216) et par
; sub_536F7/sub_7A054. Candidat prioritaire pour session dédiée.
; ==============================================================================================
UIScreen_StateMachineMain_4FBF1	proc far		; CODE XREF: UIScreen_ConstructWidgetBinding_536F7+180P
...
loc_4FC0B:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+15j
		mov	al, byte_722D1
		mov	ah, 0
		cmp	ax, 0Fh
		jz	short loc_4FC6D
...
loc_4FC1D:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+27j
		cmp	ax, 20h	; ' '
		jz	short loc_4FC25
		jmp	loc_4FEAE
; ���������������������������������������������������������������������������

loc_4FC25:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2Fj
		cmp	byte_722D0, 1
		jnz	short loc_4FC3C
		test	byte_722D3, 0Ch
		jz	short loc_4FC38
...
loc_4FC38:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+40j
		xor	ax, ax

loc_4FC3A:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+45j
		jmp	short loc_4FC51
; ���������������������������������������������������������������������������

loc_4FC3C:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+39j
		cmp	byte_72DF2, 1
		jz	short loc_4FC4A
		cmp	byte_72DFE, 1
		jnz	short loc_4FC4F

loc_4FC4A:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+50j
		mov	ax, 1
		jmp	short loc_4FC51
; ���������������������������������������������������������������������������

loc_4FC4F:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+57j
		xor	ax, ax

loc_4FC51:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FC3Aj
					; UIScreen_StateMachineMain_4FBF1+5Cj
		or	al, al
		jnz	short loc_4FC58
		jmp	loc_4FEAE
; ���������������������������������������������������������������������������

loc_4FC58:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+62j
		cmp	byte_6E33C, 0
		jnz	short loc_4FC62
		jmp	loc_4FEAE
; ���������������������������������������������������������������������������

loc_4FC62:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+6Cj
		mov	al, byte_70476
		xor	al, 1
		mov	byte_70476, al
		jmp	loc_4FEAE
...
loc_4FC6D:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+22j
		mov	byte_7046D, 1
		cmp	byte_722D0, 1
		jnz	short loc_4FC89
		test	byte_722D3, 0Ch
...
loc_4FC85:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+8Dj
		xor	ax, ax

loc_4FC87:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+92j
		jmp	short loc_4FC9E
; ���������������������������������������������������������������������������

loc_4FC89:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+86j
		cmp	byte_72DF2, 1
		jz	short loc_4FC97
		cmp	byte_72DFE, 1
		jnz	short loc_4FC9C

loc_4FC97:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+9Dj
		mov	ax, 1
		jmp	short loc_4FC9E
; ���������������������������������������������������������������������������

loc_4FC9C:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+A4j
		xor	ax, ax

loc_4FC9E:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FC87j
					; UIScreen_StateMachineMain_4FBF1+A9j
		or	al, al
		jnz	short loc_4FCA5
		jmp	loc_4FD43
; ���������������������������������������������������������������������������

loc_4FCA5:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+AFj
		mov	byte_7046C, 0
		mov	byte_7046D, 0
		cmp	word_7046E, 1
		jnz	short loc_4FCBE
...
loc_4FCBE:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+C3j
		cmp	word_7046E, 2
		jnz	short loc_4FCCD
		mov	word_7046E, 4
		jmp	short loc_4FCDA
...
loc_4FCCD:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+D2j
		cmp	word_7046E, 4
		jnz	short loc_4FCDA
		mov	word_7046E, 1

loc_4FCDA:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+CBj
					; UIScreen_StateMachineMain_4FBF1+DAj ...
		mov	ax, word_7046E
		mov	[bp+var_4], ax
		movsx	eax, [bp+var_4]
		shl	eax, 8
...
loc_4FD05:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+10Dj
		xor	ax, ax

loc_4FD07:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+112j
		or	al, al
		jz	short loc_4FD11
		mov	word_70495, 0

loc_4FD11:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+118j
		push	word_7046E
		push	33E8h
		lea	ax, [bp+var_34]
		push	ax
...
loc_4FD43:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+B1j
		cmp	byte_722D0, 1
		jnz	short loc_4FD5A
		test	byte_722D3, 0Ch
		jz	short loc_4FD56
...
loc_4FD56:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+15Ej
		xor	ax, ax

loc_4FD58:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+163j
		jmp	short loc_4FD6F
; ���������������������������������������������������������������������������

loc_4FD5A:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+157j
		cmp	byte_72DF2, 1
		jz	short loc_4FD68
		cmp	byte_72DFE, 1
		jnz	short loc_4FD6D

loc_4FD68:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+16Ej
		mov	ax, 1
		jmp	short loc_4FD6F
; ���������������������������������������������������������������������������

loc_4FD6D:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+175j
		xor	ax, ax

loc_4FD6F:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FD58j
					; UIScreen_StateMachineMain_4FBF1+17Aj
		mov	ah, 0
		or	ax, ax
		jz	short loc_4FD78
		jmp	loc_4FEAE
...
loc_4FD78:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+182j
		mov	dword_72A65, 500h
		mov	dword_72A69, 0FFFFFF00h
		jmp	loc_4FEAE
; ���������������������������������������������������������������������������

loc_4FD8D:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+29j
		cmp	byte_722D0, 1
		jnz	short loc_4FDA4
...
loc_4FDA0:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1A8j
		xor	ax, ax

loc_4FDA2:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1ADj
		jmp	short loc_4FDB9
; ���������������������������������������������������������������������������

loc_4FDA4:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1A1j
		cmp	byte_72E00, 1
		jz	short loc_4FDB2
		cmp	byte_72E21, 1
		jnz	short loc_4FDB7

loc_4FDB2:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1B8j
		mov	ax, 1
		jmp	short loc_4FDB9
; ���������������������������������������������������������������������������

loc_4FDB7:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1BFj
		xor	ax, ax

loc_4FDB9:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FDA2j
					; UIScreen_StateMachineMain_4FBF1+1C4j
		or	al, al
		jnz	short loc_4FDC0
		jmp	loc_4FEAE
; ���������������������������������������������������������������������������

loc_4FDC0:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1CAj
		mov	byte_70447, 0
		mov	[bp+var_15], 0
		xor	eax, eax
		mov	[bp+var_1A], eax
...
loc_4FDFA:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+1F8j
		push	0
		push	1
		push	ds
...
loc_4FE18:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+26Fj
		mov	eax, [bp+var_1E]
...
loc_4FE2C:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+234j
		xor	ax, ax

loc_4FE2E:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+239j
		mov	ah, 0
		or	ax, ax
		jz	short loc_4FE59
...
loc_4FE59:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FE16j
					; UIScreen_StateMachineMain_4FBF1+241j ...
		mov	al, [bp+var_15]
		mov	ah, 0
		or	ax, ax
		jz	short loc_4FE18
...
loc_4FEAC:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2ADj
		jmp	short $+2

loc_4FEAE:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+31j
					; UIScreen_StateMachineMain_4FBF1+64j ...
		cmp	byte_72DD7, 1
		jnz	short loc_4FEB9
		mov	al, 1
		jmp	short loc_4FEBB
...
loc_4FEB9:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2C2j
		mov	al, 0

loc_4FEBB:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2C6j
		or	al, al
		jz	short loc_4FF22
		cmp	byte_722D0, 1
		jnz	short loc_4FED6
...
loc_4FED2:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2DAj
		xor	ax, ax

loc_4FED4:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2DFj
		jmp	short loc_4FEEB
; ���������������������������������������������������������������������������

loc_4FED6:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2D3j
		cmp	byte_72DF2, 1
		jz	short loc_4FEE4
		cmp	byte_72DFE, 1
		jnz	short loc_4FEE9

loc_4FEE4:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2EAj
		mov	ax, 1
		jmp	short loc_4FEEB
; ���������������������������������������������������������������������������

loc_4FEE9:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2F1j
		xor	ax, ax

loc_4FEEB:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FED4j
					; UIScreen_StateMachineMain_4FBF1+2F6j
		mov	ah, 0
		or	ax, ax
		jnz	short loc_4FF22
		mov	eax, dword_72A69
...
loc_4FF22:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+2CCj
					; UIScreen_StateMachineMain_4FBF1+2FEj ...
		cmp	byte_72DD7, 1
		jnz	short loc_4FF2D
		mov	al, 1
		jmp	short loc_4FF2F
...
loc_4FF2D:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+336j
		mov	al, 0

loc_4FF2F:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+33Aj
		or	al, al
...
loc_4FF46:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+34Ej
		xor	ax, ax

loc_4FF48:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+353j
		jmp	short loc_4FF5F
; ���������������������������������������������������������������������������

loc_4FF4A:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+347j
		cmp	byte_72DF2, 1
		jz	short loc_4FF58
		cmp	byte_72DFE, 1
		jnz	short loc_4FF5D

loc_4FF58:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+35Ej
		mov	ax, 1
		jmp	short loc_4FF5F
; ���������������������������������������������������������������������������

loc_4FF5D:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+365j
		xor	ax, ax

loc_4FF5F:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FF48j
					; UIScreen_StateMachineMain_4FBF1+36Aj
		mov	ah, 0
		or	ax, ax
		jnz	short loc_4FF80
		mov	eax, dword_72A69
...
loc_4FF80:				; CODE XREF: UIScreen_StateMachineMain_4FBF1:loc_4FF31j
					; UIScreen_StateMachineMain_4FBF1+372j ...
		cmp	byte_7046D, 0
		jz	short loc_4FFAE
		cmp	byte_7046C, 0
		jz	short loc_4FFAE
...
loc_4FFAE:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+394j
					; UIScreen_StateMachineMain_4FBF1+39Bj
		cmp	word_70466, 1
		jbe	short loc_5001C
		cmp	word_722E6, 0
		jz	short loc_5001C
...
loc_4FFE6:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+3EEj
		xor	ax, ax

loc_4FFE8:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+3F3j
		or	al, al
		jz	short loc_5001C

loc_4FFEC:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+3D0j
		mov	[bp+var_14], 100h
		mov	eax, [bp+var_14]
		mov	dword_70468, eax
		mov	byte_7046C, 0
...
loc_5001C:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+3C2j
					; UIScreen_StateMachineMain_4FBF1+3C9j ...
...
loc_5004B:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+453j
		call	PIT_ReadHighPrecision
		push	dx
		push	ax
		pop	eax
...
loc_5009C:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+498j
		call	RadioFlags_ShiftHistory

loc_500A1:				; CODE XREF: UIScreen_StateMachineMain_4FBF1+17j
		mov	al, [bp+var_1]
		leave
		retf
UIScreen_StateMachineMain_4FBF1	endp
...
; ==============================================================================================
UIScreen_ReadNumericFields_500A6	proc far		; CODE XREF: UIScreen_StateMachineMain_4FBF1+457p
		push	bp
		mov	bp, sp
		push	5A92h
...
; ==============================================================================================
UIScreen_ApplyFormFields_500F6	proc far		; CODE XREF: UIScreen_Construct_53896:loc_538BAP
